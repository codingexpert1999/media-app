...
export const getProfile = (userId: number) => {
    return async (dispatch: Dispatch) => {
        try {
            ...
            const res = await axios.get(`${API}/profile/${userId}`, {...config, withCredentials: true});
...
export const getNotifications = (userId: number, profileId: number) => {
    return async (dispatch: Dispatch) => {
        try {
            ...
            const res = await axios.get(`${API}/profile/notifications/${userId}/${profileId}`, {...config, withCredentials: true});
...
export const getFriendRequests = (userId: number, profileId: number) => {
    return async (dispatch: Dispatch) => {
        try {
            ...
            const res = await axios.get(`${API}/profile/friend_requests/${userId}/${profileId}`, {...config, withCredentials: true});
...
export const getFriends = (userId: number, profileId: number) => {
    return async (dispatch: Dispatch) => {
        try {
            ...
            const res = await axios.get(`${API}/profile/friends/${userId}/${profileId}`, {...config, withCredentials: true});
...
export const sendFriendRequest = (userId: number, profileId: number, receiverProfileId: number) => {
    return async (dispatch:Dispatch) => {
        try {
            ...
            await axios.post(`${API}/profile/send_friend_request/${userId}/${profileId}`, body, {...config, withCredentials: true});
...
export const acceptFriendRequest = (userId: number, profileId: number, senderProfileId: number) => {
    return async (dispatch:Dispatch) => {
        try {
            ...
            await axios.post(`${API}/profile/accept_friend_request/${userId}/${profileId}`, body, {...config, withCredentials: true});
